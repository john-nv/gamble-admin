...
// const ChatBot = React.lazy(() => import('@views/pages/management/ChatBot'))
// const ChatBotContent = React.lazy(() => import('@views/pages/management/ChatBotContent'))
// const ChatBotGroup = React.lazy(() => import('@views/pages/management/ChatBotGroup'))
// const User = React.lazy(() => import('@views/pages/management/User'))
// const Sticker = React.lazy(() => import('@views/pages/management/Sticker'))
const Game = React.lazy(() => import('@views/pages/management/Game'))
const User = React.lazy(() => import('@views/pages/management/User'))
...
const routes = [
  ...
  { path: '/management/tro-choi', name: 'Quản Lý Trò Chơi', element: Game },
  ...
  // { path: '/management/sticker', name: 'Quản Lý Sticker', element: Sticker }
]
